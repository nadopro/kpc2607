...
function buildGraph(startTime, endTime) {
    ...
    Object.values(ipMap).forEach(ip => {
        ...
        groupUniqueIpMap[ip.group][ip.id] = true;
    });
    ...
    return {
        ...
        visibleIpCount: Object.keys(ipMap).length,
        visibleGroupCount: Object.keys(groupMap).length
    };
}
...
function updateNetwork(startTime, endTime) {
    ...
    document.getElementById("info").innerHTML =
        ...
        "<br>전체 접속 수 : " + graph.total +
        "<br>표시 대역 수 : " + graph.visibleGroupCount +
        "<br>표시 IP 수 : " + graph.visibleIpCount;
